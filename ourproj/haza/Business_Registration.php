...
if(count($data) > 0){
    ...
    $query = "insert into business_customer(company_name,company_code,bc_usename,bc_password,reg_date,bc_contact_no) values ('$first_name','$last_name','$user_name','$password','$dob','$email','$phone_No')";
